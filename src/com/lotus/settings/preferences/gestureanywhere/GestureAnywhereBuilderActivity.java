...
package com.lotus.settings.gestureanywhere;
...
import com.lotus.settings.preferences.ShortcutPickHelper;
...
public class GestureAnywhereBuilderActivity extends ListActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActionBar().setTitle(R.string.gesture_anywhere_gestures_title);
